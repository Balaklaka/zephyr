...
struct bt_mesh_blob_io {
	 ...
	 *
	 *  Used by the BLOB server on incoming data.
	 *
	 ...
	 *  non-zero value, the chunk remains unreceived, and the BLOB client
	 *  will attempt to resend it later.
	 *
	 *  Note that the client will only perform a limited number of attempts
	 *  at delivering a chunk before dropping a target from the transfer.
	 ...
	 *
	 *  Used by the BLOB client to fetch outgoing data.
	 *
