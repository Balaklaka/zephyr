...
/**
 * @file
 * @defgroup bt_mesh_dfu_metadata Bluetooth Mesh Device Firmware Update Metadata
 * @ingroup bt_mesh_dfu
 * @{
 * @brief Common types and functions for the Bluetooth Mesh Device Firmware Metadata.
 */
