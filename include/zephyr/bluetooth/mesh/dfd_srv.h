...
/**
 * @file
 * @defgroup bt_mesh_dfd_srv Device Firmware Distribution Server model
 * @ingroup bt_mesh_dfd
 * @{
 * @brief API for the Device Firmware Distribution Server model
 */
...
struct bt_mesh_dfd_srv_cb {
	 ...
	 *
	 *  Called when the DFD Server is about to delete a DFU image slot.
	 ...
	 *  fill @c io with a pointer to a readable BLOB stream for the DFD
	 *  server to read the firmware image from.
	 *
	 *  @param srv  DFD Server model instance.
