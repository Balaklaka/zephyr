...
#define BT_MESH_DFU_OP_UPDATE_INFO_STATUS BT_MESH_MODEL_OP_1(0x7c)

#define BT_MESH_DFU_OP_UPDATE_METADATA_CHECK BT_MESH_MODEL_OP_1(0x7b)
#define BT_MESH_DFU_OP_UPDATE_METADATA_STATUS BT_MESH_MODEL_OP_1(0x7a)
...
#define BT_MESH_DFU_OP_UPDATE_STATUS BT_MESH_MODEL_OP_1(0x70)
